...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        prediction_1     = classifier_1.predict(model_1, x_test) # This does not work. LinearClassifierMixin.predict() takes 2 positional arguments but 3 were given. HOW???

        classifier_2     = SVC()
        model_2          = classifier_2.fit(x_train, y_train)
        prediction_2     = classifier_2.predict(model_2, x_test)

        classifier_3     = DecisionTreeClassifier()
        model_3          = classifier_3.fit(x_train, y_train)
        prediction_3     = classifier_3.predict(model_3, x_test)
    ...
    for i in range(len(results)):
        ...
        print('R2 Score of Logistic Regression: ', r2s_1)
        print('R2 Score of SVM: ', r2s_2)
        print('R2 Score of Decision Tree: ', r2s_3)
